...
//		String name="Pune";
		...
		/*System.out.println("Multipication of two numbers: " + addNumber(op, num1, num2));
		System.out.println("division of two numbers: " + addNumber(op, num1, num2));
		System.out.println("percentile of two numbers: " + addNumber(op, num1, num2));*/
	...
	static int addNumber(char op, int num1, int num2) 
	{
		...
		/*else if(op=='-')
		{
			System.out.println("Subtraction of two numbers: " + addNumber(op, num1, num2));
