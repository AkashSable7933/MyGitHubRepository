...
public class tostringmethodExample1 extends Demo
{
	static int last_roll = 100;
	int roll_no;
	// Constructor
	tostringmethodExample1()
    {
        roll_no = last_roll;
        last_roll++;
    }
	...
	public static void main(String args[]) 
	{
		...
		tostringmethodExample1 s = new tostringmethodExample1();
		...
		Demo d2=new tostringmethodExample1();
		System.out.println(d2);	
		System.out.println("***********************************");
		System.out.println(new tostringmethodExample1());
	}
}
/**
