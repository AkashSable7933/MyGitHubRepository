...
public class StepsToReadPropertyFile 
{
	...
	public static void main(String[] args) throws IOException  
	{
		 ...
		 * relative path: .\PropertyFiles\TestData.properties ('.' --> represent current working dir)
		 * Using System class:
		 * 			String currentDir=System.getProperty("user.dir");
		 * 			String propertyFileLocation =currentDir+"\\PropertyFiles\\TestData.properties";
		 */
		String fileLocation="C:\\Users\\SONY\\Downloads\\Testing\\Automation\\TestData.properties";
