...
public class NSMethod_Void1
{
	...
	{
		age=a;
		System.out.println("I am display(int) of NSMethod_Void1 class and age value is: "+age);
	}
	
	public static void main(String[] args)
	{
		
		//NSMethod_Void1 m1;//no object creation at this step, its just a reference variable
				//new NSMethod_Void1();//yes, object got creation, but we don't know where this object got created after this step
		//m1=new NSMethod_Void1();//yes,object got created and with the help m1 reference we can access it's members
			//or
		...
		System.out.println("************************************");
		System.out.println("age: "+m3.age);//age=0
