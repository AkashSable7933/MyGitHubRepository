...
public class casting 
{
	public static void main(String[] args)
	{
		...
		System.out.println("Num3: "+num3);//100.0
		
		//narrowing
		double salary=55000.55;
		int num4=(int)salary;//explicit narrowing- data loss
		System.out.println("Salary: "+salary);//55000.55
		System.out.println("num4: "+num4);	//55000
		System.out.println("*********************************");
		calling(12345);
		System.out.println("*********************************");
		double num5=25.54;
		System.out.println("return value of display method: "+display((int)num5));//25
	}
