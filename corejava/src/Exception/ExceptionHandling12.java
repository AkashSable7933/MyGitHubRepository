...
class AkashExceltion extends Exception 
{
	public AkashExceltion(String str) 
	{
...
public class ExceptionHandling12 
{
	...
	public static void validateAge(int age) throws AkashExceltion 
	{
		if (age < 18) 
		{
			// throw Arithmetic exception if not eligible to vote
			throw new AkashExceltion("Person is not eligible to vote");
		} 
		else 
		{
	...
	public static void main(String args[]) throws AkashExceltion 
	{
